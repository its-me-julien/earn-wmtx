...
const AirNodeInfo = () => {
  const sections = [
    ...
    },
    {
      ...
      content: "Operators own & manage AirNodes, ensuring connectivity and maintenance while earning rewards for providing internet access in their communities."
    },
    {
      title: "Who can operate an AirNode?",
      content: "Anyone can operate an AirNode, from small-scale setups for homes to large solutions for businesses. Your choice depends on community needs and investment."
    }    
  ];
