...
import sparkAirnodeImg from '../../assets/airnode/spark-airnode.png';
import linkAirnodeImg from '../../assets/airnode/Link-airnode.png';
import portal180Img from '../../assets/airnode/portal180-airnode.png';
import apexAirnodeImg from '../../assets/airnode/apex-airnode.png';
import portal360Img from '../../assets/airnode/portal360-airnode.png';
import apex180Img from '../../assets/airnode/apex-180-airnode.png';
import titanImg from '../../assets/airnode/titan-airnode.png';
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm mb-2">
                      <span className="text-white">Purchase Cost:</span> <span className="font-bold text-[#F6642D]">${node.price.toFixed(2)}</span>
                    </p>
                    <p className="text-sm mb-2">
                      <span className="text-white">Annual Earnings per Subscriber:</span> <span className="font-bold text-[#F6642D]">{node.earningsPerSubscriber}</span>
                    </p>
                    <p className="text-sm mb-2">
                      <span className="text-white">Max Subscribers:</span> <span className="font-bold text-[#F6642D]">{node.maxSubscribers}</span>
                    </p>
                    <p className="text-sm mb-4">
                      <span className="text-white">Max Yearly Earnings:</span> <span className="font-bold text-[#F6642D]">${node.maxEarnings.toLocaleString()}</span>
                    </p>
                    <a
  href={node.link}
  target="_blank"
