      ...
      <div className="grid grid-cols-1 gap-6 max-w-3xl mx-auto px-4">
        <div>
          ...
          <p className="mb-6 leading-relaxed text-lg text-gray-300 text-center px-4 md:px-6">
            By hosting an AirNode, you receive a share of the rewards generated from providing connectivity to your community. Your earnings grow as more users connect through your hosted AirNode. Potential earnings with the more powerful AirNodes:
          </p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {earningsData.map((data, index) => (
          <div key={index} className="p-6 border border-[#5A2FBA] shadow-sm rounded-lg text-center">
            ...
            <p className="text-m text-gray-400">{data.description}</p>
          </div>
        ))}
      </div>
    </section>
