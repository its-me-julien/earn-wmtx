  ...
  return (
    <section className="py-16 px-6 max-w-7xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* EarthNodes */}
        <div className="card bg-gradient-to-b from-[rgba(55,10,81,0.3)] to-[rgba(55,10,81,0.6)] shadow-lg p-8 text-center rounded-lg hover:scale-105 transition-transform">
