...
import clubLogo from '../assets/club_logo.png'; // Ensure this path is correct
    ...
    <header className="navbar bg-black text-white shadow-lg sticky top-0 z-50">
      ...
      <div className="flex-1 flex items-center space-x-4">
        <Link href="/" className="flex items-center">
          ...
          World Mobile Club: The WMTx Token
          </span>
        </Link>
      </div>
      ...
      <div className="lg:hidden">
        <div className="dropdown dropdown-end">
          ...
          <ul
            tabIndex={0}
            className="menu menu-compact dropdown-content mt-3 p-2 shadow-lg bg-black text-white rounded-box w-56"
          >
            <li>
              <Link href="https://worldmobile.club">
                Community Hub
              </Link>
            </li>
            <li>
              <Link href="https://coffee.worldmobile.club">
                Stake with Coffee
              </Link>
            </li>
          </ul>
